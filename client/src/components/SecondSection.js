        ...
        <section className='secondSection'>
            ...
            <div className='quality__description'>
                ...
                <div className='image_description'>
                    <p>
                        Committed to providing engineering, construction,
                        software, IT along with media related services with
                        quality since 2020. "To provide international standard
                        sustainable engineering services in Nepal at an
                        affordable rate."
                    </p>
                </div>
